...
scion_types__msg__VisionObject__init(scion_types__msg__VisionObject * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->object_name)) {
    scion_types__msg__VisionObject__fini(msg);
    return false;
  }
  // distance
  return true;
...
scion_types__msg__VisionObject__create()
{
  ...
  scion_types__msg__VisionObject * msg = (scion_types__msg__VisionObject *)allocator.allocate(sizeof(scion_types__msg__VisionObject), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(scion_types__msg__VisionObject));
  bool success = scion_types__msg__VisionObject__init(msg);
  if (!success) {
...
scion_types__msg__VisionObject__Sequence__init(scion_types__msg__VisionObject__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  scion_types__msg__VisionObject * data = NULL;

  if (size) {
    data = (scion_types__msg__VisionObject *)allocator.zero_allocate(size, sizeof(scion_types__msg__VisionObject), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = scion_types__msg__VisionObject__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        scion_types__msg__VisionObject__fini(&data[i - 1]);
      }
...
scion_types__msg__VisionObject__Sequence__fini(scion_types__msg__VisionObject__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      scion_types__msg__VisionObject__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  scion_types__msg__VisionObject__Sequence * array = (scion_types__msg__VisionObject__Sequence *)allocator.allocate(sizeof(scion_types__msg__VisionObject__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = scion_types__msg__VisionObject__Sequence__init(array, size);
  if (!success) {
...
scion_types__msg__VisionObject__Sequence__destroy(scion_types__msg__VisionObject__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    scion_types__msg__VisionObject__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
scion_types__msg__VisionObject__Sequence__are_equal(const scion_types__msg__VisionObject__Sequence * lhs, const scion_types__msg__VisionObject__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!scion_types__msg__VisionObject__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  scion_types__msg__VisionObject__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(scion_types__msg__VisionObject);
    scion_types__msg__VisionObject * data =
      (scion_types__msg__VisionObject *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!scion_types__msg__VisionObject__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          scion_types__msg__VisionObject__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!scion_types__msg__VisionObject__copy(
