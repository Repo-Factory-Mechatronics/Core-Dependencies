...
#ifndef SCION_TYPES__SRV__DETAIL__CAN_COMMAND__FUNCTIONS_H_
#define SCION_TYPES__SRV__DETAIL__CAN_COMMAND__FUNCTIONS_H_
...
/// Initialize srv/CanCommand message.
/**
...
/// Finalize srv/CanCommand message.
/**
...
/// Create srv/CanCommand message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * scion_types__srv__CanCommand_Request__init().
...
/// Destroy srv/CanCommand message.
/**
 * It calls
 * scion_types__srv__CanCommand_Request__fini()
...
/// Check for srv/CanCommand message equality.
/**
...
/// Initialize array of srv/CanCommand messages.
/**
...
/// Finalize array of srv/CanCommand messages.
/**
 * It calls
 * scion_types__srv__CanCommand_Request__fini()
...
/// Create array of srv/CanCommand messages.
/**
 * It allocates the memory for the array and calls
 * scion_types__srv__CanCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CanCommand messages.
/**
 * It calls
 * scion_types__srv__CanCommand_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CanCommand message array equality.
/**
...
/// Copy an array of srv/CanCommand messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * scion_types__srv__CanCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scion_types
...
/**
 * It calls
 * scion_types__srv__CanCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_scion_types
...
/**
 * It allocates the memory for the array and calls
 * scion_types__srv__CanCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scion_types
...
/**
 * It calls
 * scion_types__srv__CanCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SCION_TYPES__SRV__DETAIL__CAN_COMMAND__FUNCTIONS_H_
