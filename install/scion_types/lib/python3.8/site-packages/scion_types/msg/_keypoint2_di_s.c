...
bool scion_types__msg__keypoint2_di__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("scion_types.msg._keypoint2_di.Keypoint2Di", full_classname_dest, 41) == 0);
  }
  scion_types__msg__Keypoint2Di * ros_message = _ros_message;
  {  // kp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * scion_types__msg__keypoint2_di__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Keypoint2Di */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("scion_types.msg._keypoint2_di");
  ...
  scion_types__msg__Keypoint2Di * ros_message = (scion_types__msg__Keypoint2Di *)raw_ros_message;
  {  // kp
    PyObject * field = NULL;
