...
bool scion_types__msg__raw_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("scion_types.msg._raw_data.RawData", full_classname_dest, 33) == 0);
  }
  scion_types__msg__RawData * ros_message = _ros_message;
  {  // device
  ...
  {  // datatype
    ...
    ros_message->datatype = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // format
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * scion_types__msg__raw_data__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RawData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("scion_types.msg._raw_data");
  ...
  scion_types__msg__RawData * ros_message = (scion_types__msg__RawData *)raw_ros_message;
  {  // device
    PyObject * field = NULL;
  ...
  {  // datatype
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->datatype);
    {
